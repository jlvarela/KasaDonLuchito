 ...
 * @author victor
 */
@Named(value = "mantenedorDisparadorAgregarMB")
@ViewScoped
public class MantenedorDisparadorAgregarMB implements Serializable {
    @EJB
    ...
    public void agregarDisparador() {
        
        try {
            //disparadorFacade.crearDisparador(nombre, accionaEscena, idDispSeleccionado, valorAccionDispositivo, idEscenaSeleccionada, CommonFunctions.getUsuarioLogueado());
            CommonFunctions.viewMessage(FacesMessage.SEVERITY_INFO,
                    "Se ha creado un disparador",
                    "Se ha creado el disparador \"".concat(nombre).concat("\""));
            ...
            CommonFunctions.viewMessage(FacesMessage.SEVERITY_ERROR, 
                    e.getMessage(), 
                    e.getMessage());
            //CommonFunctions.goToPage("/faces/users/admin/agregarDisparador.xhtml?faces-redirect=true");
        }
    }
     ...
     */
    public MantenedorDisparadorAgregarMB() {
